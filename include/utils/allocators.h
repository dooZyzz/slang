...
#define VM_FREE(ptr, size) SLANG_MEM_FREE(allocators_get(ALLOC_SYSTEM_VM), ptr, size)
...
#define OBJ_FREE(ptr, size) SLANG_MEM_FREE(allocators_get(ALLOC_SYSTEM_OBJECTS), ptr, size)
...
#define STR_FREE(ptr, size) SLANG_MEM_FREE(allocators_get(ALLOC_SYSTEM_STRINGS), ptr, size)
...
#define COMPILER_FREE(ptr, size) SLANG_MEM_FREE(allocators_get(ALLOC_SYSTEM_COMPILER), ptr, size)
...
#define MODULE_FREE(ptr, size) SLANG_MEM_FREE(allocators_get(ALLOC_SYSTEM_MODULES), ptr, size)
